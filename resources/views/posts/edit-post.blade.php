...
<!--            </div>-->
      ...
      <label for="photo" class="block text-sm font-medium leading-6 text-gray-900">Photo Edit</label>
  <div class="mt-2 flex items-center gap-x-3">
    <input class="hidden" type="file" accept="image/*" name="picture" id="picture" />
    <img class="h-50 w-50 rounded" src="{{$post->picture_url}}" />
